    ...
    return `
      ...
      <html>
        <head>
          ...
          <title>GutChecks Evidence Export - ${data.title}</title>
          <style>
            * {
              margin: 0;
              padding: 0;
        ...
        <body>
          <!-- Header -->
          <div class="header">
            <div class="logo">🛡️ GutChecks Evidence Export</div>
          ...
          ${data.messages
            ...
            <div class="message message-${msg.role}">
              <div class="message-header">
                <span class="message-role">${msg.role === 'user' ? '👤 You' : '🤖 GutChecks AI'}</span>
          ...
          <div class="legal-notice">
            ...
            This document contains a timestamped record of conversations and analysis generated by GutChecks,
          ...
          <!-- Watermark -->
          <div class="watermark">
            <div class="watermark-logo">GutChecks</div>
            <p>Confidential & Anonymous Analysis Platform</p>
            <p>https://mygutcheck.org | Generated: ${formatDate(Date.now())}</p>
            <p>This document was generated by the GutChecks app and contains authenticated timestamps.</p>
          </div>
        </body>
      </html>
    `;
